...
namespace InventorySystem1._0
{
    public partial class frmUsers : Form
    {
        ...
        {
            string sql = "SELECT username AS 'Username', attempt_time AS 'Time', status AS 'Status' FROM login_audit ORDER BY attempt_time DESC";
            config.Load_DTG(sql, dtg_auditLog);
        }
